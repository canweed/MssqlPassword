...
public class MssqlPassword {
	 ...
	 * @param dbEncodedPassword 디비에서 입력된 비밀번호
	 * @return 맞으면 true
	 */
	public static boolean pwdCompare(String password, String dbEncodedPassword) {
		try {

			// mssql 형식이 아니면 실패
			if (!dbEncodedPassword.startsWith("0x0200"))
				return false;
			
			byte[] saltArray = DatatypeConverter.parseHexBinary(dbEncodedPassword.substring(6, 14));
			byte[] dataDigest = DatatypeConverter.parseHexBinary(dbEncodedPassword.substring(14));
			
			// 2. 다이제스트 축출 ( From data )
			MessageDigest md = MessageDigest.getInstance("SHA-512");
			...
			// 3. 배열 비교
			return Arrays.equals(digest, dataDigest);
	...
	public static void main(String[] args) {
		...
		System.out.println(pwdCompare("abcd", "0x0200638B956A888EB630D0BC549CEDAE920663F02B2E8DF7F10C1D5A5847651188367D77D0F72BC65FFBD4DF24D51EE57F77C5EFC1C69790F92D65CC599F6486A39521C5B7AA"));
	}
}
